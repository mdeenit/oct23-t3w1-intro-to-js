...
let nonCitrusFruits = fruitsChoices.filter((fruit) => {
    // if one of these two condition is true, the fruit is good! 
    // NO! 
...
let alexsFavouriteFruitsIsAvailable = fruitsChoices.includes("mangoes");  
console.log("Alex's favourite fruit is available: " + alexsFavouriteFruitsIsAvailable)
